...
bool ardupilot_msgs__msg__propulsion__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ardupilot_msgs.msg._propulsion.Propulsion", full_classname_dest, 41) == 0);
  }
  ardupilot_msgs__msg__Propulsion * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Propulsion */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ardupilot_msgs.msg._propulsion");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Propulsion");
